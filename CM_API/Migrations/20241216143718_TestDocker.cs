...
{
    /// <inheritdoc />
    public partial class TestDocker : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TheaterChains", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Theaters_TheaterChains_ChainId",
                        column: x => x.ChainId,
                        principalTable: "TheaterChains",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoubleSeatId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
